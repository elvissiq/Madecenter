	...
	If nTotPed != 0
		...
		While ! QRY_PED->(EoF())
			...
			While ! QRY_ITE->(EoF())
				...
				oPrintPvt:SayAlign(nLinAtu, nPosVlIP,  Alltrim(Transform((QRY_ITE->L2_VALIPI), cMaskVlr)),	oFontDet, 100, 07, , nPadLeft,)
				oPrintPvt:SayAlign(nLinAtu, nPosVlST,  Alltrim(Transform((QRY_ITE->L2_ICMSRET), cMaskVlr)),	oFontDet, 100, 07, , nPadLeft,)
				oPrintPvt:SayAlign(nLinAtu, nPosVDes,  Alltrim(Transform(QRY_ITE->L2_VALDESC, cMaskPrc)), 	oFontDet, 100, 07, , nPadLeft,)
				oPrintPvt:SayAlign(nLinAtu, nPosVTot,  Alltrim(Transform(nVlrItem, cMaskVlr)), 			  	oFontDet, 100, 07, , nPadLeft,)
				nLinAtu += 10
...
Static Function fImpCab()
	...
	oPrintPvt:SayAlign(nLinCab, nPosVUni,  "Vlr. Unit.", 	oFontDetN, 200, 07,, nPadLeft,)
	oPrintPvt:SayAlign(nLinCab, nPosVlIP,  "Vlr. IPI",	    oFontDetN, 200, 07,, nPadLeft,)
	oPrintPvt:SayAlign(nLinCab, nPosVlST,  "Vlr. ST",	    oFontDetN, 200, 07,, nPadLeft,)
	oPrintPvt:SayAlign(nLinCab, nPosVDes,  "Desconto",  	oFontDetN, 200, 07,, nPadLeft,)
	oPrintPvt:SayAlign(nLinCab, nPosVTot,  "Vlr.Total",  	oFontDetN, 200, 07,, nPadLeft,)
...
Static Function fImpTot()
	...
	nTotAPagar := (nValorTot + QRY_PED->L1_FRETE) - SL1->L1_DESCONT

    oPrintPvt:SayAlign(nLinAtu, nPosVTot-60, "Total a Pagar:", oFontCabN, 200, 07, , nPadLeft, )
	oPrintPvt:SayAlign(nLinAtu, nPosVTot, 	 Alltrim(Transform(nTotAPagar, cMaskVlr)),oFontCabN, 200, 07, , nPadLeft, )
Return
